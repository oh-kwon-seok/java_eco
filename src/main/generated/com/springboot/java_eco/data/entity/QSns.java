...
public class QSns extends EntityPathBase<Sns> {
    ...
    public final EnumPath<com.springboot.java_eco.authentication.domain.oauth.OAuthProvider> oAuthProvider = createEnum("oAuthProvider", com.springboot.java_eco.authentication.domain.oauth.OAuthProvider.class);

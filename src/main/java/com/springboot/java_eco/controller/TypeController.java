...
public class TypeController {
    ...
    public ResponseEntity<List<Type>> getTotalType(@ModelAttribute CommonSearchDto commonSearchDto) throws RuntimeException{

        long currentTime = System.currentTimeMillis();

        List<Type> selectedTotalType = typeService.getTotalType(commonSearchDto);
    ...
    public ResponseEntity<List<Type>> getType(@ModelAttribute CommonSearchDto commonSearchDto) throws RuntimeException{

        long currentTime = System.currentTimeMillis();

        List<Type> selectedTotalType = typeService.getType(commonSearchDto);
